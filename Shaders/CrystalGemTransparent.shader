Shader "lilPBR/Crystal/Gem Transparent"
{
    Properties
    {
        [LILFoldout(Surface)]
        ...
        _FiberStrength ("动态絮状强度", Range(0.0, 1.0)) = 0.75
        ...
        [LILFoldout(Reflection And Highlight)]
        _Smoothness ("平滑度", Range(0.0, 1.0)) = 0.9
        _ReflectionStrength ("反射强度", Range(0.0, 1.0)) = 0.35
        _ReflectionFresnel ("反射菲涅尔", Range(0.05, 4.0)) = 1.0
        _ReflectionRoughness ("反射粗糙度", Range(0.0, 1.0)) = 0.08
        [HDR] _ReflectionTint ("反射染色", Color) = (1,1,1,1)
