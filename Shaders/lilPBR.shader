Shader "lilPBR/lilPBR"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_fragment _ DEBUG_DISPLAY
            #if defined(LILPBR_SKIP_ADDITIONAL_LIGHT_SHADOWS)
                ...
                #pragma skip_variants LIGHTMAP_SHADOW_MIXING SHADOWS_SHADOWMASK DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTMAP_BICUBIC_SAMPLING DYNAMICLIGHTMAP_ON USE_LEGACY_LIGHTMAPS
            #endif
            #if defined(LILPBR_SKIP_DEBUG_DISPLAY)
                #pragma skip_variants DEBUG_DISPLAY
            #endif
        ...
        Pass
        {
            ...
            #define SHADERPASS SHADERPASS_DEPTHNORMALSONLY
            #include "unity_urp.hlsl"
            #define LILPBR_MAIN_SAMPLER sampler_trilinear_repeat
            #define LILPBR_PBR_SAMPLER sampler_trilinear_repeat
            #define LILPBR_PARALLAX_SAMPLER sampler_trilinear_repeat
            #include "pbr_core.hlsl"
            #include "metadata_buffer.hlsl"
            ...
            half4 frag (v2f i, bool isFront : SV_IsFrontFace DEPTH_OUT) : SV_Target
            {
                ...
                LODFadeCrossFade(i.pos);
                #endif
                return LilPbrMetadataBufferSurfaceColorFrag(i, isFront, depth);
            }
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            LilPbrMetadataBufferOutput frag (v2f i, bool isFront : SV_IsFrontFace DEPTH_OUT)
            {
                UNITY_SETUP_INSTANCE_ID(i);
                UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(i);
                #ifdef LOD_FADE_CROSSFADE
                LODFadeCrossFade(i.pos);
                #endif
                return LilPbrMetadataBufferFrag(i, isFront, depth);
            }
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            half4 frag (v2f i, bool isFront : SV_IsFrontFace DEPTH_OUT) : SV_Target
            {
                ...
                LODFadeCrossFade(i.pos);
                #endif
                return LilPbrGeometryBufferFrag(i, isFront, depth);
            }
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "unity_urp.hlsl"
            #include "pbr_core.hlsl"
            #include "hocharacter_capture.hlsl"
            ...
            LilHoCharacterCaptureOutput frag (v2f i, bool isFront : SV_IsFrontFace DEPTH_OUT)
            {
                UNITY_SETUP_INSTANCE_ID(i);
                UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(i);
                #ifdef LOD_FADE_CROSSFADE
                LODFadeCrossFade(i.pos);
                #endif
                return HoCharacterCaptureFrag(i, isFront);
            }
            ENDHLSL
        }
