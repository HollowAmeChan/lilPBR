Shader "lilPBR/Crystal/Gem MatCap Parallax 8"
{
    Properties
    {
        [LILFoldout(Surface)]
        ...
        _CrystalMask ("表面遮罩 (R/B 边缘, G 厚度)", 2D) = "white" {}
    ...
    CBUFFER_START(UnityPerMaterial)
        ...
        float _CrystalGemParallaxFresnel;
    ...
    #include "crystal_matcap_parallax_gem_core.hlsl"
    ENDHLSL
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment CrystalFragMatCapParallaxGem
